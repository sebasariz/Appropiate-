 ...
 */
public class LoadAsignacionModulos extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            jSONArray = GetDynamicTable.getUsuariosAsignacionModulos(usuarios);

            request.setAttribute("grid", jSONArray);
            content = "/pages/asignacionmodulos/asignacionmodulos.jsp";
