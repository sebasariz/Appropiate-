 ...
 * @author sebasariz
 */
public class LoadGruposDeInteresJson extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            ArrayList<GrupoInteres> grupoIntereses = new ArrayList<>(usuarioResponse.getGrupoInteresCollection());
            ...
            ArrayList<GrupoInteres> grupoInteresesEntidad = new ArrayList<>(entidad.getGrupoInteresCollection());
            jSONObject.put("grid", GetDynamicTable.getGruposTable(grupoIntereses,grupoInteresesEntidad));
