 ...
 * @author sebasariz
 */
public class ChangeEntity extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        int idSelected = Integer.parseInt(request.getParameter("id"));
        ...
        if (usuario != null) {
            ...
            Entidad entidad = entidadJpaController.findEntidad(idSelected);
            session.setAttribute("entidadGlobal", entidad);
