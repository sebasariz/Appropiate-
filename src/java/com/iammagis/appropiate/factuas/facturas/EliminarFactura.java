 ...
 * @author sebasariz
 */
public class EliminarFactura extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            logUsuario.setActividad("Eliminando factura: " + factura.getReferencia());
            logUsuario.setTipo(17);
            logUsuarioJpaController.create(logUsuario);
            
            
            facturaJpaController.destroy(id);
