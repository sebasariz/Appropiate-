 ...
 * @author sebasariz
 */
public class CrearPlantilla extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            System.out.println("campos: " + facturaTemplate.getCampos());

            Entidad entidad = (Entidad) session.getAttribute("entidadGlobal");

            facturaTemplate.setEntidadIdentidad(entidad);
            facturaTemplate.setFechaCreacion(BigInteger.valueOf(System.currentTimeMillis()));
            facturaTemplate.setFechaModificado(BigInteger.valueOf(System.currentTimeMillis()));

            FacturaTemplateJpaController facturaTemplateJpaController = new FacturaTemplateJpaController(manager);
            facturaTemplateJpaController.create(facturaTemplate);
