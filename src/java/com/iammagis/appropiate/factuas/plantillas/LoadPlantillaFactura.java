 ...
 */
public class LoadPlantillaFactura extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            request.setAttribute("grid",  GetDynamicTable.getFacturaTemplate(facturaTemplates)); 
            content = "/pages/facturas/planillafacturas.jsp";
