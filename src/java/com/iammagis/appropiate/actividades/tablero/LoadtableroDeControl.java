 ...
 */
package com.iammagis.appropiate.actividades.tablero;
 ...
 */
public class LoadtableroDeControl extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            request.setAttribute("grid", GetDynamicTable.getTableroActividades(actividads));
            String content = "/pages/actividades/tablerodecontrol.jsp";
