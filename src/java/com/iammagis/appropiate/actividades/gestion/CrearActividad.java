 ...
 * @author sebasariz
 */
public class CrearActividad extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            Actividad actividadObject = new Actividad();
            actividadObject.setActividad(actividad);
            actividadObject.setCorreoResponsable(correo);
            actividadObject.setFecha(BigInteger.valueOf(fecha));
            actividadObject.setResponsable(responsable);
            actividadObject.setEntidadIdentidad(entidad);

            ActividadJpaController actividadJpaController = new ActividadJpaController(manager);
            actividadObject = actividadJpaController.create(actividadObject);
            ...
            logUsuario.setActividad("Creando actividad: " + actividadObject.getActividad());
            logUsuario.setTipo(3);
            ...
            correos.add(correo);
            Correo correoSender = new Correo("Nueva actividad asignada", template, correos);
            correoSender.start();
            
            jSONObject.put("id", actividadObject.getIdactividad());
        } else {
