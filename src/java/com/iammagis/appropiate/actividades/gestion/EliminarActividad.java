 ...
 * @author sebasariz
 */
public class EliminarActividad extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            Actividad actividadObj = actividadJpaController.findActividad(id);
            ...
            logUsuario.setActividad("Eliminando actividad: " + actividadObj.getActividad());
            logUsuario.setTipo(5);
            logUsuarioJpaController.create(logUsuario);

            actividadJpaController.destroy(id);
