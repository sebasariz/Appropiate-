 ...
 */
public class ResultadoEncuesta extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            jSONObject.put("grid", GetDynamicTable.getResultadoEncuesta(new ArrayList<>(encuesta.getPreguntaCollection())));
