 ...
 */
public class LoadPersonasResultado extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            for (Respuesta respuesta : respuestas) {
                Usuario usuarioTable = respuesta.getUsuarioIdusuario();

                table += "<tr>"
                        + "<td>" + usuarioTable.getNombre() + "</td>"
                        + "<td class=\"text-success text-center\">" + usuarioTable.getApellidos() + "</td>"
                        + "<td class=\"text-center\">" + usuarioTable.getCorreo() + "</td>"
                        + "</tr>";
