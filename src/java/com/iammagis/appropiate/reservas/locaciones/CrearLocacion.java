 ...
 * @author sebasariz
 */
public class CrearLocacion extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            locacion.setEntidadIdentidad(entidad);
            ...
            try {
                ...
                if (fname.length() == 0) {
                    ...
                    fos.close();
                    locacion.setImagen(fname);
                }
            } catch (Exception e) {
                e.printStackTrace();
                System.out.print("ERROR-------" + e);
            }
            locacionJpaController.create(locacion);
