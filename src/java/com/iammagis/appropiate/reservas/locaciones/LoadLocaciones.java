 ...
 */
public class LoadLocaciones extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            request.setAttribute("grid", GetDynamicTable.getLocaciones(locacions));
            String content = "/pages/reservas/locacionesyhorarios.jsp";
