 ...
 */
public class LoadEventoJson extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            jSONObject.put("identidad", evento.getEntidadIdentidad().getIdentidad());
            jSONObject.put("nombre", evento.getNombre());
            jSONObject.put("informacion", evento.getInformacion());
            jSONObject.put("fecha", evento.getFecha().longValue());
            jSONObject.put("img", "img/" + evento.getImagen());
            jSONObject.put("paras", new JSONArray(evento.getIdparaString()));
        } else {
