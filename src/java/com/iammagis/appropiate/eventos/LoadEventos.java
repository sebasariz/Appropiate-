 ...
 */
public class LoadEventos extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            request.setAttribute("grid", GetDynamicTable.getEventos(eventos));
            String content = "/pages/eventos/eventos.jsp";
