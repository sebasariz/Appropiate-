...
public class EncuestaHasUsuarioPK implements Serializable {
    ...
    public EncuestaHasUsuarioPK(int encuestaIdencuesta, int usuarioIdusuario) {
    ...
    public String toString() {
        return "com.iammagis.appropiate.beans.EncuestaHasUsuarioPK[ encuestaIdencuesta=" + encuestaIdencuesta + ", usuarioIdusuario=" + usuarioIdusuario + " ]";
    }
