 ...
 * @author sebasariz
 */
public class CrearGrupoDeInteres extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            grupoInteres.setEntidadIdentidad(entidad);
            grupoInteres.setFecha(BigInteger.valueOf(System.currentTimeMillis()));
            grupoInteresJpaController.create(grupoInteres);
