 ...
 * @author sebasariz
 */
public class EditarGrupoDeInteres extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            GrupoInteres grupoInteres = (GrupoInteres) form;

            GrupoInteres grupoInteresAnterior = grupoInteresJpaController.findGrupoInteres(grupoInteres.getIdgrupoInteres());
            grupoInteresAnterior.setNombre(grupoInteres.getNombre());
            grupoInteresJpaController.edit(grupoInteresAnterior);
            //validar el email
            ...
            jSONObject.put("grid", GetDynamicTable.getGruposDeInteres(grupoIntereses));
