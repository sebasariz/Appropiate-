 ...
 * @author sebasariz
 */
public class LoadGrupoDeInteresJson extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            jSONObject.put("id", grupoInteres.getIdgrupoInteres());
            jSONObject.put("nombre", grupoInteres.getNombre());
        } else {
