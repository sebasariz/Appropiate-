 ...
 */
public class ResultadoCampanas extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            jSONObject.put("grid", GetDynamicTable.getResultadoCampanas(new ArrayList<>(campanaComunicados.getCampanaComunicadosHasUsuarioCollection())));
