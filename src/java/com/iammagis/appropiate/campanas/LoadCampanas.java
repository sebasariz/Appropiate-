 ...
 */
public class LoadCampanas extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
        ...
        if (usuario != null) {
            ...
            request.setAttribute("grid", GetDynamicTable.getCampanasComunicados(campanaComunicadoses));
            String content = "/pages/campanas/campanas.jsp";
