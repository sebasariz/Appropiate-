...
<html>
    <div class="page-header no-breadcrumb font-header">
        <bean:message key="appropiate.campanas"/>
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#"><bean:message key="appropiate.campanas"/></a></li> 
    </ol>
            ...
            <div class="modal-content">
                ...
                <form id="gestion" method="post" enctype="multipart/form-data">
                    <div class="modal-body" > 
                        <input type="hidden" name="idcampana" id="idcampana">  
    ...
    <script src="js-in/campanas.js"></script>
    <script>
                                            $(function () {
